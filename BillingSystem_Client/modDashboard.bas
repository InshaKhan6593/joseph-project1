...
Public Sub RefreshDashboard()
    ...
    ' Unprotect sheets for VBA writes (UserInterfaceOnly resets on workbook reopen)
    UnprotectSheet "Dashboard"
    UnprotectSheet "Transactions"
    ...
    ' Re-protect sheets
    ProtectSheet "Dashboard"
    ProtectSheet "Transactions"

    TogglePerformance False
    Exit Sub
ErrHandler:
    ' Re-protect on error too
    On Error Resume Next
    ProtectSheet "Dashboard"
    ProtectSheet "Transactions"
    On Error GoTo 0
